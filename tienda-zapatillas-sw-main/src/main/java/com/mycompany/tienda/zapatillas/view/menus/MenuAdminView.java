...
public class MenuAdminView extends javax.swing.JFrame {
    ...
    private void btnReportesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReportesActionPerformed
        try {
        // 1) Obtener lista de productos desde el DAO
        com.mycompany.tienda.zapatillas.dao.ProductoDAO productoDAO = new com.mycompany.tienda.zapatillas.dao.ProductoDAO();
        java.util.List<com.mycompany.tienda.zapatillas.model.Producto> productos = productoDAO.listarProductos();

        if (productos == null || productos.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "No hay productos en el inventario para generar el reporte.");
            return;
        }
        ...
        chooser.setSelectedFile(new java.io.File("reporte_inventario.pdf"));
        ...
        reporte.generarReporteInventario(productos, ruta);
        ...
        javax.swing.JOptionPane.showMessageDialog(this, "Reporte de inventario generado en: " + ruta);
    } catch (Exception ex) {
        ex.printStackTrace();
        javax.swing.JOptionPane.showMessageDialog(this, "Error al generar el reporte: " + ex.getMessage(), "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh
        try {
            com.mycompany.tienda.zapatillas.controller.VentaController controlador =
            new com.mycompany.tienda.zapatillas.controller.VentaController();
            controlador.generarReporteVentasDesdeVista(this);
        } catch (Exception ex) {
            ex.printStackTrace();
